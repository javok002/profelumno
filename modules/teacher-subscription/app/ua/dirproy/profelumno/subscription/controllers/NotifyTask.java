            ...
            public void run() {
                ...
                if(teacher != null){
                    ...
                    String message = "<body style=\"-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size: 14px;line-height: 1.428571429;color: #333;background-color: #fff;\">\n" +
                            ...
                            "                    El tiempo de prueba se acabara en una semana. A partir del "+teacher.getRenewalDate() +" se le empezara a debitar mensualmente de su cuenta el monto de $0.000 por el servicio. Si no desea mantener su servicio, puede cerrar su cuenta.\n" +
                            "                </div>\n" +
